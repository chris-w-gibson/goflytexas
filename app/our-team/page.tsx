          ...
          <div className="max-w-4xl mx-auto text-center">
            ...
            <div className="grid md:grid-cols-3 gap-6 mt-12">
              <div className="bg-sky-50 p-6 rounded-lg">
                ...
                <h3 className="font-semibold text-black mb-2">Personal Mentorship</h3>
                <p className="text-black">One instructor throughout your journey</p>
              </div>
              <div className="bg-sky-50 p-6 rounded-lg">
                <Target className="h-8 w-8 text-sky-600 mx-auto mb-3" />
                <h3 className="font-semibold text-black mb-2">Goal-Oriented</h3>
                <p className="text-black">Training tailored to your aviation dreams</p>
              </div>
              <div className="bg-sky-50 p-6 rounded-lg">
                <Heart className="h-8 w-8 text-sky-600 mx-auto mb-3" />
                <h3 className="font-semibold text-black mb-2">Supportive Environment</h3>
                <p className="text-black">Questions encouraged, progress celebrated</p>
              </div>
            </div>
          </div>
        </div>
              ...
              <div className="p-8">
                <div className="grid md:grid-cols-3 gap-6 mb-6">
                  <div className="text-center">
                    ...
                    <h4 className="font-semibold text-black">20+ Years Experience</h4>
                    <p className="text-black">Over 10,000 flight hours</p>
                  </div>
                  <div className="text-center">
                    <div className="w-16 h-16 bg-sky-100 rounded-full flex items-center justify-center mx-auto mb-3">
                      <GraduationCap className="h-8 w-8 text-sky-600" />
                    </div>
                    <h4 className="font-semibold text-black">500+ Students</h4>
                    <p className="text-black">Successfully trained</p>
                  </div>
                  <div className="text-center">
                    <div className="w-16 h-16 bg-sky-100 rounded-full flex items-center justify-center mx-auto mb-3">
                      <Award className="h-8 w-8 text-sky-600" />
                    </div>
                    <h4 className="font-semibold text-black">Gold Seal CFI</h4>
                    <p className="text-black">FAA recognized excellence</p>
                  </div>
                </div>
          ...
          <div className="grid md:grid-cols-2 gap-8 max-w-4xl mx-auto">
            ...
            <div className="bg-white rounded-lg shadow-lg p-6">
              <div className="flex items-center mb-4">
                ...
                <div>
                  <h3 className="text-xl font-bold text-black">Senior Flight Instructor</h3>
                  <p className="text-black">CFI, CFII</p>
                </div>
              </div>
              
              <div className="space-y-2 mb-4">
                <p className="text-black"><strong>Experience:</strong> 8 years, 3,000+ hours</p>
                <p className="text-black"><strong>Background:</strong> Former military pilot</p>
                <p className="text-black"><strong>Focus:</strong> Instrument training specialist</p>
              </div>
            ...
            <div className="bg-white rounded-lg shadow-lg p-6">
              <div className="flex items-center mb-4">
                ...
                <div>
                  ...
                  <p className="text-black">CFI</p>
                </div>
              </div>
              
              <div className="space-y-2 mb-4">
                <p className="text-black"><strong>Experience:</strong> 5 years, 1,500+ hours</p>
                <p className="text-black"><strong>Background:</strong> Regional airline pilot</p>
                <p className="text-black"><strong>Focus:</strong> Private & Commercial training</p>
              </div>
