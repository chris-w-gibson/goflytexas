          ...
          <div className="grid md:grid-cols-2 gap-8">
            ...
            <div className="bg-navy-800 border border-navy-700 rounded-lg p-8 shadow-lg shadow-navy-950/20">
              <div className="flex items-center mb-6">
                ...
                <h2 className="text-2xl font-bold text-white">Biennial Flight Review</h2>
              </div>
              ...
              <h3 className="font-semibold text-white mb-3">BFR Includes:</h3>
              <ul className="space-y-2 mb-6">
                <li className="flex items-start">
                  <CheckCircle className="h-5 w-5 text-green-400 mr-2 flex-shrink-0 mt-0.5" />
                  <span className="text-navy-100">1+ hour ground review of regulations</span>
                </li>
                <li className="flex items-start">
                  <CheckCircle className="h-5 w-5 text-green-400 mr-2 flex-shrink-0 mt-0.5" />
                  <span className="text-navy-100">1+ hour flight covering maneuvers</span>
                </li>
                <li className="flex items-start">
                  <CheckCircle className="h-5 w-5 text-green-400 mr-2 flex-shrink-0 mt-0.5" />
                  <span className="text-navy-100">Emergency procedures review</span>
                </li>
                <li className="flex items-start">
                  <CheckCircle className="h-5 w-5 text-green-400 mr-2 flex-shrink-0 mt-0.5" />
                  <span className="text-navy-100">Airspace and weather refresher</span>
                </li>
                <li className="flex items-start">
                  <CheckCircle className="h-5 w-5 text-green-400 mr-2 flex-shrink-0 mt-0.5" />
                  <span className="text-navy-100">Logbook endorsement</span>
                </li>
              </ul>
            ...
            <div className="bg-navy-800 border border-navy-700 rounded-lg p-8 shadow-lg shadow-navy-950/20">
              <div className="flex items-center mb-6">
                <div className="w-12 h-12 bg-navy-700 rounded-full flex items-center justify-center mr-4">
                  <Navigation2 className="h-6 w-6 text-sky-400" />
                </div>
                <h2 className="text-2xl font-bold text-white">Instrument Proficiency Check</h2>
              </div>
              ...
              <h3 className="font-semibold text-white mb-3">IPC Includes:</h3>
              <ul className="space-y-2 mb-6">
                <li className="flex items-start">
                  <CheckCircle className="h-5 w-5 text-sky-400 mr-2 flex-shrink-0 mt-0.5" />
                  <span className="text-navy-100">Ground review of IFR procedures</span>
                </li>
                <li className="flex items-start">
                  <CheckCircle className="h-5 w-5 text-sky-400 mr-2 flex-shrink-0 mt-0.5" />
                  <span className="text-navy-100">Multiple instrument approaches</span>
                </li>
                <li className="flex items-start">
                  <CheckCircle className="h-5 w-5 text-sky-400 mr-2 flex-shrink-0 mt-0.5" />
                ...
                <li className="flex items-start">
                  <CheckCircle className="h-5 w-5 text-sky-400 mr-2 flex-shrink-0 mt-0.5" />
                  <span className="text-navy-100">Emergency procedures under IFR</span>
                </li>
                <li className="flex items-start">
                  <CheckCircle className="h-5 w-5 text-sky-400 mr-2 flex-shrink-0 mt-0.5" />
                  <span className="text-navy-100">IFR currency restoration</span>
                </li>
              </ul>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="bg-navy-800 p-6 rounded-lg shadow-lg shadow-navy-950/20 text-center border border-navy-700">
              ...
              <p className="text-navy-100">Refresh critical skills and stay sharp on emergency procedures</p>
            </div>
            ...
            <div className="bg-navy-800 p-6 rounded-lg shadow-lg shadow-navy-950/20 text-center border border-navy-700">
              ...
              <p className="text-navy-100">Meet FAA requirements and maintain legal flying status</p>
            </div>
            ...
            <div className="bg-navy-800 p-6 rounded-lg shadow-lg shadow-navy-950/20 text-center border border-navy-700">
              ...
              <h3 className="text-lg font-semibold text-white mb-2">Confidence Building</h3>
              <p className="text-navy-100">Feel assured in your abilities with regular practice</p>
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="space-y-6">
            <div className="flex items-start">
              ...
              <div className="ml-6">
                <h3 className="text-xl font-semibold text-white mb-2">Pre-Review Assessment</h3>
                <p className="text-navy-100">We discuss your experience level, recent flying, and areas you'd like to focus on</p>
              </div>
            </div>
            ...
            <div className="flex items-start">
              ...
              <div className="ml-6">
                <h3 className="text-xl font-semibold text-white mb-2">Tailored Ground Session</h3>
                <p className="text-navy-100">Review regulations, weather, and procedures relevant to your flying</p>
              </div>
            </div>
            ...
            <div className="flex items-start">
              ...
              <div className="ml-6">
                <h3 className="text-xl font-semibold text-white mb-2">Practical Flight Review</h3>
                <p className="text-navy-100">Practice maneuvers and procedures in a supportive environment</p>
              </div>
            </div>
            ...
            <div className="flex items-start">
              ...
              <div className="ml-6">
                <h3 className="text-xl font-semibold text-white mb-2">Debrief & Endorsement</h3>
                <p className="text-navy-100">Receive feedback, tips for improvement, and your logbook endorsement</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="bg-navy-800 rounded-lg shadow-lg shadow-navy-950/20 p-8 border border-navy-700">
            ...
            <div className="grid md:grid-cols-2 gap-6">
              <div className="flex items-start">
                <Clock className="h-6 w-6 text-sky-400 mr-3 flex-shrink-0 mt-1" />
                <div>
                  <h3 className="font-semibold text-white mb-2">BFR Timing</h3>
                  <p className="text-navy-100">Every 24 calendar months from your last review</p>
                </div>
              </div>

              <div className="flex items-start">
                <AlertCircle className="h-6 w-6 text-sky-400 mr-3 flex-shrink-0 mt-1" />
                <div>
                  <h3 className="font-semibold text-white mb-2">IPC Timing</h3>
                  <p className="text-navy-100">When IFR currency lapses beyond 6 months</p>
                </div>
              </div>
            </div>

            <div className="mt-6 p-4 bg-navy-700 rounded-lg">
              <p className="text-navy-200 text-center font-medium">
